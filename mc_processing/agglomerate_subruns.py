...
for i in range(len(lowfilelist)):
    ...
    # File types and keys have changed over the years, so
    # we're gonna have to name each key specifically...
    ...
    lown_gen += i3wd.NEvents[0] # running total of simulated events combined here
...
# Every event feature that I think might be useful for analysis
