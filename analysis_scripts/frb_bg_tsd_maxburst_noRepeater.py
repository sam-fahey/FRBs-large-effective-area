...
r = options.randomseed # set random seed
dT = options.centertime # Search time window
N = options.N_trials # number of realizations of search
...
# set the dimensions and resolution of background PDF
# this fits a cubic spline to a 20x20 histogram in zenith and azimuth
analysis.set_pdf_space_bg (bins=20, azimuth=True)

# no signal dependence on energy
